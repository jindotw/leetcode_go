...
that, given a non-empty array A consisting of N integers, returns the length of the list constructed from A in the
above manner.
...
func arrListLen(A []int) int {
	...
	for currentNode != -1 && !visited[currentNode] {
